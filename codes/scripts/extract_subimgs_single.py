...
parser.add_argument('-i', type=str, dest='input_folder', default=None, help='input_folder')
parser.add_argument('-o', type=str, dest='save_folder', default=None, help='save_folder')
parser.add_argument('-crop_sz', '--crop_sz', type=int, default=0)
